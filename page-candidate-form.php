...
<section class="page-hero page-hero-simple">
	...
	<div class="container page-hero-inner">
		<span class="eyebrow-badge"><?php echo sam_icon( 'users' ); ?> Candidate Registration</span>
		<h1>Register Your Candidate Profile</h1>
		<p>Serving notice or ready for immediate placement? Share your details to connect with top hiring employers.</p>
	</div>
</section>
	...
	<div class="container container-narrow">
		<?php if ( 'success' === $status ) : ?>
			<div class="form-notice form-notice-success" role="status">
				...
				Thank you! Your candidate profile and documents have been submitted successfully. Our recruitment team will get in touch with you shortly.
			</div>
		...
		<form class="candidate-form hiring-form" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" enctype="multipart/form-data">
			...
			<p class="form-submit" style="margin-top: 30px;">
				<button type="submit" class="btn btn-primary btn-lg">Submit Candidate Profile</button>
			</p>
		</form>
	</div>
</section>
